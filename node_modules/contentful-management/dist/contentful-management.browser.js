...
function createClient(params) {
  ...
  var userAgentHeader = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_2__["getUserAgentHeader"])('contentful-management.js/' + '5.16.0', params.application, params.integration, params.feature);
...
function createOrganizationApi(_ref) {
  ...
  var baseURL = http.defaults.baseURL.replace('/spaces/', '/organizations/' + orgId);
  ...
  function getOrganizationMembership(id) {
    return http.get('organization_memberships/' + id, {
      ...
      return wrapOrganizationMembership(http, response.data, orgId);
...
/* harmony import */ var _organization_membership__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./organization-membership */ "./entities/organization-membership.js");
/* harmony import */ var _role__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./role */ "./entities/role.js");
/* harmony import */ var _api_key__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./api-key */ "./entities/api-key.js");
/* harmony import */ var _preview_api_key__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./preview-api-key */ "./entities/preview-api-key.js");
/* harmony import */ var _upload__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./upload */ "./entities/upload.js");
/* harmony import */ var _organization__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./organization */ "./entities/organization.js");
/* harmony import */ var _ui_extension__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./ui-extension */ "./entities/ui-extension.js");
/* harmony import */ var _snapshot__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./snapshot */ "./entities/snapshot.js");
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./user */ "./entities/user.js");
/* harmony import */ var _personal_access_token__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./personal-access-token */ "./entities/personal-access-token.js");
/* harmony import */ var _usage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./usage */ "./entities/usage.js");
/* harmony import */ var _environment_alias__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./environment-alias */ "./entities/environment-alias.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  organizationMembership: _organization_membership__WEBPACK_IMPORTED_MODULE_9__,
  role: _role__WEBPACK_IMPORTED_MODULE_10__,
  apiKey: _api_key__WEBPACK_IMPORTED_MODULE_11__,
  previewApiKey: _preview_api_key__WEBPACK_IMPORTED_MODULE_12__,
  upload: _upload__WEBPACK_IMPORTED_MODULE_13__,
  organization: _organization__WEBPACK_IMPORTED_MODULE_14__,
  uiExtension: _ui_extension__WEBPACK_IMPORTED_MODULE_15__,
  snapshot: _snapshot__WEBPACK_IMPORTED_MODULE_16__,
  user: _user__WEBPACK_IMPORTED_MODULE_17__,
  ...
  return {
    ...
    delete: function _delete() {
      return http.delete('organization_memberships' + '/' + this.sys.id, {
        ...
        baseURL: baseURL
      }).then(function (response) {}, _error_handler__WEBPACK_IMPORTED_MODULE_3__["default"]);
    }
  };
}
 ...
 */
function wrapOrganizationMembership(http, data, orgId) {
  ...
  Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(organizationMembership, createOrganizationMembershipApi(http, orgId));
...
/* harmony import */ var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! contentful-sdk-core */ "../node_modules/contentful-sdk-core/dist/index.es-modules.js");
/* harmony import */ var _create_organization_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../create-organization-api */ "./create-organization-api.js");
...
function wrapOrganization(http, data) {
  var organization = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(data));

  var organizationApi = Object(_create_organization_api__WEBPACK_IMPORTED_MODULE_2__["default"])({
    http: http,
    orgId: organization.sys.id
  });
  var enhancedOrg = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_3__["default"])(organization, organizationApi);
  return Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["freezeSys"])(enhancedOrg);
}
